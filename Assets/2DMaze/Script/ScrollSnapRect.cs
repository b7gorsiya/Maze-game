...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    Animator[] avtar_anim;
    [SerializeField]
    Start_Scene_UI_Mangment ui;
    void Start() {
        _scrollRectComponent = GetComponent<ScrollRect>();
        _scrollRectRect = GetComponent<RectTransform>();
        _container = _scrollRectComponent.content;
        _pageCount = _container.childCount;
        avtar_anim = _container.GetComponentsInChildren<Animator>();
    ...
    private void SetPage(int aPageIndex) {
        ...
        ui.Set_Buttons_ForCharachter(aPageIndex);
    ...
    private void LerpToPage(int aPageIndex) {
        ...
        // My code - Khuong Duy
        // BY  ME ##################      HomeScript._Instance.UpdateUIHeroPage(aPageIndex);
        //	MainMenu.insmain.ButtonShowEvents(aPageIndex);
        ui.Set_Buttons_ForCharachter(aPageIndex);
        avtar_anim[aPageIndex].Play(0);
    }
    ...
    private void NextScreen() {
        GameController.instanse.audiomanager.SwipeSound();
